...
class IntermountainDataModule(pl.LightningDataModule):
    def __init__(self, cfg):
        super().__init__()

        self.cfg = cfg
        self.dataset = image_dataset.IntermountainImageDataset
...
class CandidPtxDataModule(pl.LightningDataModule):
    def __init__(self, cfg):
        ...
        self.cfg = cfg
        self.dataset = image_dataset.CandidPtxImageDataset
