...
CHEXPERT_CLASS_PROMPTS = {
    'Atelectasis': {
        ...
        'subtype': ['subsegmental atelectasis', 'linear atelectasis', 'trace atelectasis', 'bibasilar atelectasis', 'retrocardiac atelectasis', 'bandlike atelectasis', 'residual atelectasis'],
        'location': ['at the mid lung zone', 'at the upper lung zone', 'at the right lung zone', 'at the left lung zone', 'at the lung bases', 'at the right lung base', 'at the left lung base', 'at the bilateral lung bases', 'at the left lower lobe', 'at the right lower lobe']},
    'Cardiomegaly': {
        'severity': [''],
        'subtype': [
    ...
    'Consolidation': {
        ...
        'subtype': ['bilateral consolidation', 'reticular consolidation', 'retrocardiac consolidation', 'patchy consolidation', 'airspace consolidation', 'partial consolidation'],
        'location': ['at the lower lung zone', 'at the upper lung zone', 'at the left lower lobe', 'at the right lower lobe', 'at the left upper lobe', 'at the right uppper lobe', 'at the right lung base', 'at the left lung base']},
    'Edema': {
