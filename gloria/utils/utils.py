...
def normalize(similarities, method='norm'):
    ...
    if method == 'norm': 
        ...
        return (similarities - similarities.min(axis=0)) / (similarities.max(axis=0) - similarities.min(axis=0))
    else: 
...
COLOR_DIC = {0:[128,64,128],  1:[244, 35,232],
             ...
             38:[0,  0, 70],  39:[0, 0,  0],
             40:[128,64,128],  41:[244, 35,232],
             42:[70, 70, 70],  43:[102,102,156],
             44:[190,153,153], 45:[153,153,153],
             46:[250,170, 30], 47:[220, 220, 0],
             48:[107,142, 35], 49:[152,251,152],
             50:[70,130,180], 51:[220,20, 60],
             52:[255, 0, 0],  53:[0, 0, 142],
             54:[119,11, 32], 55:[0, 60,100],
             56:[0, 80, 100], 57:[0, 0, 230],
             58:[0,  0, 70],  59:[0, 0,  0],
             60:[128,64,128],  61:[244, 35,232],
             62:[70, 70, 70],  63:[102,102,156],
             64:[190,153,153], 65:[153,153,153],
             66:[250,170, 30], 67:[220, 220, 0],
             68:[107,142, 35], 69:[152,251,152],
             70:[70,130,180], 71:[220,20, 60],
             72:[255, 0, 0],  73:[0, 0, 142],
             74:[119,11, 32], 75:[0, 60,100],
             76:[0, 80, 100], 77:[0, 0, 230],
             78:[0,  0, 70],  79:[0, 0,  0],
             80:[128,64,128],  81:[244, 35,232],
             82:[70, 70, 70],  83:[102,102,156],
             84:[190,153,153], 85:[153,153,153],
             86:[250,170, 30], 87:[220, 220, 0],
             88:[107,142, 35], 89:[152,251,152],
             90:[70,130,180], 91:[220,20, 60],
             92:[255, 0, 0],  93:[0, 0, 142],
             94:[119,11, 32], 95:[0, 60,100],
             96:[0, 80, 100], 97:[0, 0, 230],
             98:[0,  0, 70],  99:[0, 0,  0],
             }
FONT_MAX = 50
...
def drawCaption(convas,  vis_size, sents, off1=2, off2=2):
    ...
    for i in range(len(sents)):
        ...
        for j in range(len(cap)):
            ...
            d.text(((len(sentence) + off1) * (vis_size + off2), i * FONT_MAX), '%s' % (word),
...
def build_attention_images(real_imgs, 
                           attn_maps, 
